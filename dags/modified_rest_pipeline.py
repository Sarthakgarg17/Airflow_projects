...
def upload_file_csv():
    ...
    timestamp = datetime.now(pytz.timezone('Asia/Kolkata')).strftime("%d-%H-%M-%S")
    client.upload_file('/opt/airflow/files/test.csv', 'my-random-bucket-003/new-data', f'coin-price-csv-{timestamp}')
...
# URL='s3://my-random-bucket-003/'
# CREDENTIALS=(AWS_KEY_ID='AKIA367EEXSWUH46Y4NK' AWS_SECRET_KEY='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')
# DIRECTORY = (ENABLE = TRUE)
# FILE_FORMAT = my_csv_format
# PATTERN = 'new-data/*|reprocess-data/*';'''
...
with DAG(
    ...
    py_task1>>py_task2>>py_task3>>snow_task3
